<div>
  <form name="searchSpecificSubstanceForm" id="searchSpecificSubstanceForm" action="{{route('substances.search')}}" method="GET">
    <input type="hidden" value="1" name="searchSpecificSubstance">
    <input type="text" wire:model.live.debounce.300ms="search" name="searchSubstance" id="searchSubstance" class="w-full px-4 py-2 border border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent transition duration-200 ease-in-out">
    <div class="mt-4">
