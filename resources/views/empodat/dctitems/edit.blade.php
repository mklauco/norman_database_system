          ...
          <form action="{{route('dctitems.update', $dctitem->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <table class="table-standard">
              ...
              <tr class="bg-slate-100">
                ...
                <td class="py-1 px-2">
                  <input type="text" name="name" value="{{$dctitem->name}}" class="form-text">
                </td>
              </tr>
              <tr class="bg-slate-100">
                <td class="py-1 px-2">Description</td>
                <td class="py-1 px-2">
                  <input type="text" name="description" value="{{$dctitem->description}}" class="form-text">
                </td>
              </tr>
            ...
            <div class="flex justify-end m-2">
              <button type="submit" class="btn-submit"> Update Item 
              </button>
            </div>
          </form>
        </div>
