    ...
    <div class="w-full mx-auto sm:px-6 lg:px-8">
      <div class="bg-white shadow-lg sm:rounded-lg" >
        <div class="p-6 text-gray-900" x-data="recordsTable()" x-init="initLeaflet()">
          ...
          <a href="{{ route('arbg.bacteria.search.filter', [
        ...
        <table class="table-standard">
          <thead>
            <tr class="bg-gray-600 text-white">
              ...
              <th>Sample Matrix</th>
              <th>Sampling Date</th>
              <th>Bacterial Group</th>
              <th>Abundance [CFUs/ml]</th>
          ...
          <tbody>
            ...
            <tr class="@if($loop->odd) bg-slate-100 @else bg-slate-200 @endif">
              ...
              <td class="p-1 text-center">
                @if($e->bacterialGroup)
                {{ $e->bacterialGroup->name }}
                @elseif($e->bacterial_group_other)
                {{ $e->bacterial_group_other }}
                @else
                <span class="text-gray-400">N/A</span>
                @endif
              </td>
              ...
              <td class="p-1 text-center">
                @if(isset($e->coordinate->country_id))
