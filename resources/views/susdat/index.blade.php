            ...
            <table class="table-auto w-full border-separate border-spacing-1 text-xs">
              ...
              <tbody>
                ...
                <tr class="@if($loop->odd) bg-slate-100 @else bg-slate-200 @endif">
                  <td class="p-1 text-center"><a class="text-sky-500 hover:text-white hover:bg-sky-500 border-b-2 border-transparent hover:border-sky-500 px-2 py-1 rounded transition duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-sky-500" href="{{route('substances.show', $substance->id)}}">{{$substance->id}}</a></td>
