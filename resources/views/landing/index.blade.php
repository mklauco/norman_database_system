  ...
  <div class="px-4">
    <div class="2xl:w-2/3 xl:w-full mx-auto sm:px-6 lg:px-8 space-y-6">
      @if (session('session_expired'))
        <div class="bg-amber-50 border border-amber-600 rounded-lg p-4 text-sm text-gray-800">
          Your session has expired. Please <a href="{{ route('login') }}" class="link-lime-text">log in</a> again.
        </div>
      @endif
