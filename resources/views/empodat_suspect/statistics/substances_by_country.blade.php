...
@section('page-title', 'Substances by Country')
@section('page-subtitle', 'Number of distinct substances detected per country')
  ...
  @else
    ...
    <div class="bg-slate-50 border border-slate-200 rounded-lg p-4 mb-6">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div>
          <div class="text-sm text-gray-600">Average Substances per Country</div>
          <div class="text-2xl font-bold text-gray-900">
