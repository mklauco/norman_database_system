...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('ecotox_lowestpnec_main', function (Blueprint $table) {
            ...
            $table->text('lowest_AF')->nullable()->default(null);
            ...
            $table->integer('lowest_active')->nullable()->default(null);
            $table->integer('lowest_color')->nullable()->default(null);
            $table->datetime('lowest_year')->nullable()->default(null);
            $table->integer('lowest_pnec')->nullable()->default(null);
