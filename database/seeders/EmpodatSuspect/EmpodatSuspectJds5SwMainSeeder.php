...
/**
 * Stream JDS5 SURFACE WATER xlsx → populate `empodat_suspect_main`,
 ...
 *     {@see EmpodatSuspectJds5SwXlsxStationsMappingFillSeeder}.
 ...
 */
class EmpodatSuspectJds5SwMainSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->command->info('Streaming JDS5 SURFACE WATER → empodat_suspect_main + empodat_suspect_metadata + empodat_suspect_substances (file_id='
            .self::FILE_ID.')...');
...
// php artisan db:seed --class=Database\\Seeders\\EmpodatSuspect\\EmpodatSuspectJds5SwMainSeeder
