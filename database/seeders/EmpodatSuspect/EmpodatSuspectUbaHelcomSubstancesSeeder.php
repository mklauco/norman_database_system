...
class EmpodatSuspectUbaHelcomSubstancesSeeder extends Seeder
{
    ...
    {
        $this->command->info('Processing UBA-HELCOM substances for empodat_suspect_substances table...');
...
// php artisan db:seed --class=Database\\Seeders\\EmpodatSuspect\\EmpodatSuspectUbaHelcomSubstancesSeeder
