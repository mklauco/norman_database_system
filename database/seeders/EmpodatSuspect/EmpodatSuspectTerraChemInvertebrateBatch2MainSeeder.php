...
/**
 * Stream TerraChem INVERTEBRATE 2nd batch xlsx → populate `empodat_suspect_main`,
 ...
 *
 * 2nd batch deviations from the first TerraChem invertebrate file (10012):
 *   - 58 station columns, not 83, and their headers are the full
 *     `TChem-…-2025` form matched against empodat_stations.sample_code — see
 *     {@see EmpodatSuspectTerraChemInvertebrateBatch2XlsxStationsMappingFillSeeder}.
 ...
 */
class EmpodatSuspectTerraChemInvertebrateBatch2MainSeeder extends Seeder
{
    ...
    protected const FILE_NAME = 'TerraChem Invertebrates 2nd Batch.xlsx';
    ...
    public function run(): void
    {
        ...
        $this->command->info('Streaming TerraChem INVERTEBRATE 2nd batch → empodat_suspect_main + empodat_suspect_metadata + empodat_suspect_substances (file_id='
            .self::FILE_ID.')...');
...
// php artisan db:seed --class=Database\\Seeders\\EmpodatSuspect\\EmpodatSuspectTerraChemInvertebrateBatch2MainSeeder
