...
class EmpodatSuspectSedimentSubstancesSeeder extends Seeder
{
    ...
    {
        $this->command->info('Processing CONNECT 1 SEDIMENT substances for empodat_suspect_substances table...');
...
// php artisan db:seed --class=Database\\Seeders\\EmpodatSuspect\\EmpodatSuspectSedimentSubstancesSeeder
