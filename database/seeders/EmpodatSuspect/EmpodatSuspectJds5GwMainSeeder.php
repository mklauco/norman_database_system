...
/**
 * Stream JDS5 GROUNDWATER xlsx → populate `empodat_suspect_main`,
 ...
 *
 * JDS5 GROUNDWATER deviations:
 *   - 7 station columns; `Identification_Proofs` is ABSENT from this file's
 *     metadata block (12 columns, not 13). METADATA_COLUMN_MAP still lists it —
 *     the per-row lookup is `$sourceRow[$sourceCol] ?? null`, so the column
 *     simply lands as NULL rather than failing.
 *   - Units are `ng/L`, a water matrix, not the biota `μg/kg ww`.
 *
 ...
 *     {@see EmpodatSuspectJds5GwXlsxStationsMappingFillSeeder}.
 ...
 */
class EmpodatSuspectJds5GwMainSeeder extends Seeder
{
    ...
    protected const FILE_NAME = 'SUSPECT_GW_JDS5_EI_20260627.xlsx';
    ...
    public function run(): void
    {
        ...
        $this->command->info('Streaming JDS5 GROUNDWATER → empodat_suspect_main + empodat_suspect_metadata + empodat_suspect_substances (file_id='
            .self::FILE_ID.')...');
...
// php artisan db:seed --class=Database\\Seeders\\EmpodatSuspect\\EmpodatSuspectJds5GwMainSeeder
