...
/**
 * Stream JDS5 BIOTA xlsx → populate `empodat_suspect_main`,
 ...
 *     {@see EmpodatSuspectJds5BiotaXlsxStationsMappingFillSeeder}.
 ...
 */
class EmpodatSuspectJds5BiotaMainSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->command->info('Streaming JDS5 BIOTA → empodat_suspect_main + empodat_suspect_metadata + empodat_suspect_substances (file_id='
            .self::FILE_ID.')...');
...
// php artisan db:seed --class=Database\\Seeders\\EmpodatSuspect\\EmpodatSuspectJds5BiotaMainSeeder
