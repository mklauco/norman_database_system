...
/**
 * Insert one row per station column from TerraChem INVERTEBRATE 2nd batch into
 ...
 *
 * Source file: storage/app/public/empodat_suspect/TerraChem Invertebrates 2nd Batch.xlsx
 * Station columns: everything AFTER 'Units' and BEFORE 'mz score' (the metadata
 * block boundary), MINUS any 'Blank ...' filler column. Expected: 58 stations.
 * This particular file carries no Blank columns; the skip is kept because
 * other TerraChem files do.
 *
 * See: Empodat-Suspect-3-new-source.md §11 (TerraChem)
 */
class EmpodatSuspectTerraChemInvertebrateBatch2XlsxStationsMappingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->command->info('Reading xlsx headers from TerraChem INVERTEBRATE 2nd batch (file_id='.self::FILE_ID.')...');
...
// php artisan db:seed --class=Database\\Seeders\\EmpodatSuspect\\EmpodatSuspectTerraChemInvertebrateBatch2XlsxStationsMappingSeeder
