...
class EmpodatSuspectConnect2BiotaXlsxStationsMappingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $now = Carbon::now();
        $path = storage_path('app/public/empodat_suspect/headers_OK_CONNECT 2_suspect screening results_ng g wet weight_1192 - BIOTA v2.csv');
        ...
        $this->command->info('Seeding CONNECT 2 BIOTA stations to empodat_suspect_xlsx_stations_mapping table...');
