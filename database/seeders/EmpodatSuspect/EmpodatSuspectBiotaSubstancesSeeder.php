...
class EmpodatSuspectBiotaSubstancesSeeder extends Seeder
{
    use WithoutModelEvents;

    protected ?int $fileId = 10002;
    ...
    {
        $this->command->info('Processing CONNECT 1 BIOTA substances for empodat_suspect_substances table...');
...
// php artisan db:seed --class=Database\\Seeders\\EmpodatSuspect\\EmpodatSuspectBiotaSubstancesSeeder
