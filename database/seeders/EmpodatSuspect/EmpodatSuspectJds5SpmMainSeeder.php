...
/**
 * Stream JDS5 SPM xlsx → populate `empodat_suspect_main`,
 ...
 *
 * JDS5 SPM deviations:
 *   - 7 station columns behind TWO control columns, `Fabric Blank for SPM JDS5`
 *     and `Procedural Blank for SPM JDS5`.
 *   - The metadata block is complete: all 13 columns present, unlike the JDS5
 *     groundwater file (10018) which omits `Identification_Proofs`.
 ...
 *     {@see EmpodatSuspectJds5SpmXlsxStationsMappingFillSeeder}.
 ...
 */
class EmpodatSuspectJds5SpmMainSeeder extends Seeder
{
    use LoadsSubstanceCaches;
    use WithoutModelEvents;

    protected const FILE_ID = 10019;

    protected const FILE_NAME = 'SUSPECT_SPM_JDS5_EI_20260825.xlsx';
    ...
    public function run(): void
    {
        ...
        $this->command->info('Streaming JDS5 SPM → empodat_suspect_main + empodat_suspect_metadata + empodat_suspect_substances (file_id='
            .self::FILE_ID.')...');
...
// php artisan db:seed --class=Database\\Seeders\\EmpodatSuspect\\EmpodatSuspectJds5SpmMainSeeder
