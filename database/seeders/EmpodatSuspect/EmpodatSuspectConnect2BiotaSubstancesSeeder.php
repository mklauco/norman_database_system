...
class EmpodatSuspectConnect2BiotaSubstancesSeeder extends Seeder
{
    ...
    {
        $this->command->info('Processing CONNECT 2 BIOTA substances for empodat_suspect_substances table...');

        // Increase PHP memory limit for large Excel files
        ini_set('memory_limit', '2G');
        ini_set('max_execution_time', '7200');

        $path = storage_path('app/public/empodat_suspect/OK_CONNECT 2_suspect screening results_ng g wet weight_1192 - BIOTA v2.xlsx');
...
// php artisan db:seed --class=Database\\Seeders\\EmpodatSuspect\\EmpodatSuspectConnect2BiotaSubstancesSeeder
