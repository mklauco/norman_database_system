...
class EmpodatSuspectHelcomSedimentsSubstancesSeeder extends Seeder
{
    use WithoutModelEvents;

    protected ?int $fileId = 10005;
    ...
    {
        $this->command->info('Processing HELCOM PreEMPT SEDIMENTS substances for empodat_suspect_substances table...');
...
// php artisan db:seed --class=Database\\Seeders\\EmpodatSuspect\\EmpodatSuspectHelcomSedimentsSubstancesSeeder
