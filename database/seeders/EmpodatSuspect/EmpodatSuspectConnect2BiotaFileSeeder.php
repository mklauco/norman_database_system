...
/**
 * Point the CONNECT 2 BIOTA `files` row (id=10004) at the v2 source file.
 *
 ...
 */
class EmpodatSuspectConnect2BiotaFileSeeder extends Seeder
{
    use WithoutModelEvents;

    private const int FILE_ID = 10004;

    private const string ORIGINAL_NAME = 'OK_CONNECT 2_suspect screening results_ng g wet weight_1192 - BIOTA v2.xlsx';

    private const string FILE_PATH = 'empodat_suspect/OK_CONNECT 2_suspect screening results_ng g wet weight_1192 - BIOTA v2.xlsx';
...
// php artisan db:seed --class=Database\\Seeders\\EmpodatSuspect\\EmpodatSuspectConnect2BiotaFileSeeder
