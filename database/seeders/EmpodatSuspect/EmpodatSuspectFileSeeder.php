...
class EmpodatSuspectFileSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $files = [
            ...
            [
                'id' => 10003,
                'original_name' => 'OK_CONNECT 2_suspect screening results_ng g dry weight_1192 - SEDIMENTS v2.xlsx',
                'name' => 'CONNECT 2 SEDIMENTS Suspect Screening Results',
                'description' => 'CONNECT 2 suspect screening results - SEDIMENTS data',
                'file_path' => 'empodat_suspect/OK_CONNECT 2_suspect screening results_ng g dry weight_1192 - SEDIMENTS v2.xlsx',
                'mime_type' => 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet',
                'database_entity_id' => 18,
            ],
            [
                'id' => 10004,
                'original_name' => 'OK_CONNECT 2_suspect screening results_ng g wet weight_1192 - BIOTA v2.xlsx',
                'name' => 'CONNECT 2 BIOTA Suspect Screening Results',
                'description' => 'CONNECT 2 suspect screening results - BIOTA data',
                'file_path' => 'empodat_suspect/OK_CONNECT 2_suspect screening results_ng g wet weight_1192 - BIOTA v2.xlsx',
                'mime_type' => 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet',
                'database_entity_id' => 18,
            ],
            [
