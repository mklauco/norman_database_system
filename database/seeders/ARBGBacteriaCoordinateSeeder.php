...
class ARBGBacteriaCoordinateSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $target_table_name = $this->table_prefix.'bacteria_coordinates';
        $now = Carbon::now();
        $startTime = microtime(true);
        $path = base_path().'/database/seeders/seeds/'.$this->table_prefix.'tables/arb_coordinate.csv';
...
// php artisan db:seed --class=ARBGBacteriaCoordinateSeeder
